...
<a href="https://<?php echo $_SERVER['HTTP_HOST']; ?><?php echo $this->request->webroot?>reset/<?php echo $key . 'BXX' . $rand . 'XXB' . $id ?>/">
	<?php echo __('Hier klicken um Passwort zurückzusetzen'); ?>
</a>
<hr />
<p><?php echo __('Alternativ kopieren Sie diesen Link in Ihren Browser'); ?>:
</p>
<p>https://<?php echo $_SERVER['HTTP_HOST']; ?><?php echo $this->request->webroot?>reset/<?php echo $key . 'BXX' . $rand . 'XXB' . $id ?>/</p>
